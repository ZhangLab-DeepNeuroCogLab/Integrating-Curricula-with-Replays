...
def run(gpu, seed):
    ...
    os.mkdir(f"../Results/VaryReplayClassSeq/Instanceez2hard-seed{seed}/")
    ...
    dfaccuracybybatch.to_pickle(f"../Results/VaryReplayClassSeq/Instanceez2hard-seed{seed}/Accuracy by class.pkl")
      
    x1=range(len(totalaccuracy))
    y1=totalaccuracy
    dftotalaccuracy = pd.DataFrame(data={"Accuracy":y1}, index=x1) 
    dftotalaccuracy.to_pickle(f"../Results/VaryReplayClassSeq/Instanceez2hard-seed{seed}/Total Accuracy.pkl")
