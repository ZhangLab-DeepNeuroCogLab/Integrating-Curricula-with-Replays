...
def run(gpu, dataseqseed, shuffleseed):
    ...
    os.mkdir(f"../Results/VaryReplayClassSeq/shuffleseed{shuffleseed}-seed{dataseqseed}/")
    ...
    dfaccuracybybatch.to_pickle(f"../Results/VaryReplayClassSeq/shuffleseed{shuffleseed}-seed{dataseqseed}/Accuracy by class.pkl")
      
    x1=range(len(totalaccuracy))
    y1=totalaccuracy
    dftotalaccuracy = pd.DataFrame(data={"Accuracy":y1}, index=x1) 
    dftotalaccuracy.to_pickle(f"../Results/VaryReplayClassSeq/shuffleseed{shuffleseed}-seed{dataseqseed}/Total Accuracy.pkl")
